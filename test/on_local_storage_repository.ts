...
/// <reference path="../src/on_local_storage_repository.ts" />
...
module DDD.Spec {
    ...
    describe('OnLocalStorageRepository', () => {
        ...
        var repository: OnLocalStorageRepository<DDD.NumberIdentity, Person>;
        ...
        beforeEach(() => {
            repository = new OnLocalStorageRepository({
