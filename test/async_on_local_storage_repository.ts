...
/// <reference path="../src/async_on_local_storage_repotitory.ts" />
...
module DDD.Spec {
    ...
    describe('AsyncOnLocalStorageRepository', () => {

        var repository: AsyncOnLocalStorageRepository<DDD.NumberIdentity, Person>;
        ...
        beforeEach(() => {
            repository = new AsyncOnLocalStorageRepository<DDD.NumberIdentity, Person>({
